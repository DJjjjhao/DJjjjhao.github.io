...
<a href='https://github.com/XiaomiMiMo/MiMo'><i class="fab fa-github"></i>[GitHub]</a>
  ...
  Core contributor. Process the code pre-training and post-training data, and propose a test-difficulty–driven code reward to mitigate the sparse-reward problem in code reinforcement learning.
